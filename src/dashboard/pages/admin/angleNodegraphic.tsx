                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
                        ...
                        <div className="flex flex-row items-center justify-between sm:justify-end gap-3">
                            <div className="flex items-center gap-x-2">
                                ...
                                {timeMode === "week" && <DatePicker selected={selectedDate} onChange={(date) => setSelectedDate(date)} locale={ko} customInput={<WeekInput />} placeholderText="주차 선택" popperClassName="z-[9999]" portalId="root" />}
