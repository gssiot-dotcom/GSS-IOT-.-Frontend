        ...
        <div className='grid grid-cols-12 gap-4 w-full h-screen px-4 py-4'>
            <ScrollArea className='col-span-12 md:col-span-4 overflow-auto h-full rounded-lg border border-slate-400 bg-white p-4 -mt-5 2xl:h-[95vh] w-[90%]'>
                ...
                <div className='flex justify-between mb-4 gap-2 items-end'>
                    {[
                        { key: 'B', label: '정상', color: 'bg-blue-500', setter: setB, value: B },
                        { key: 'G', label: '안전', color: 'bg-green-500', setter: setG, value: G },
                ...
                <div className='flex justify-center mb-4 gap-2'>
                    <button
                        className={`px-3 py-1 rounded-lg font-bold text-xs text-white transition-colors duration-200 ${viewMode === 'general'
                            ? 'bg-blue-600'
                    ...
                    <button
                        className={`px-3 py-1 rounded-lg font-bold text-xs text-white transition-colors duration-200 ${viewMode === 'delta'
                            ? 'bg-purple-600'
                            : 'bg-gray-400 hover:bg-gray-500'
                            }`}
                    ...
                    <button
                        className={`px-3 py-1 rounded-lg font-bold text-xs text-white transition-colors duration-200 ${viewMode === 'avgDelta'
                            ? 'bg-green-600'
                            : 'bg-gray-400 hover:bg-gray-500'
                            }`}
