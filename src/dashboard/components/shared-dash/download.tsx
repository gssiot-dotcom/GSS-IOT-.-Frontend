...
import type { IGateway } from '@/types/interfaces'
...
const DownloadButtons = ({ buildingId, angleNodes, buildingName, gateways = [] }: Props) => {
	// 보고서(HWPX)
			...
			<CardContent className='p-1.5 flex flex-col gap-3'>
				<div className='grid grid-cols-1 md:grid-cols-4 gap-3 w-full'>
					<Button
						...
						onClick={() => setIsGatewaysEditOpen(true)}
					>
						게이트웨이 정보
					</Button>
					{/* 노드 정보 */}
